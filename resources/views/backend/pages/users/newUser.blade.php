                    ...
                    <div class="cc" style="width: 100%">
                        <form action="{{ route('userCreated') }}" method="post">
                            ...
                            <fieldset class="container" style="width: 100%">
                                <legend class="container" style="text-align: center">Create New User</legend>
                                ...
                                <div class="container">
                                    ...
                                    <div
                                        ...
                                        <input type="text" class="form-control inp" name="name" placeholder="name"
                                            style="border-bottom: 0px" value="{{ old('name') }}">
                                    </div>
                                ...
                                <div class="container">
                                    ...
                                    <div
                                        ...
                                        <input type="text" class="form-control" name="email"
                                            placeholder="abc@gmail.com" style="border-bottom: 0px" style="outline: none"
                                            value="{{ old('email') }}">
                                    </div>
                                    <span class="text_danger">
                                        @error('email')
                                ...
                                <div class="container">
                                    ...
                                    <div
                                        ...
                                        <input type="password" class="form-control" name="rePassword"
                                            style="border-bottom: 0px" placeholder="Re-type password">
                                    </div>
                                    <span class="text_danger">
                                        @error('rePassword')
