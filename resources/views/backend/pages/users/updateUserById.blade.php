        ...
        <div class="container " style="width: 40%;">
            <div class="row">
                <div class="cc" style="width: 100%">
                    <form action="{{ route('userUpdatedById') }}" method="post">
                        @csrf
                        <fieldset class="container" style="width: 100%">
                            <legend class="container" style="text-align: center">Update User</legend>

                            <div class="container">
                                <label> Id :</label>
                                <div style="border: 1px solid #000000;padding-top: 4px;padding-left: 4px;padding-right: 4px;border-radius: 6px;">
                                    <input type="text" class="form-control inp" name="id" placeholder="id" style="border-bottom: 0px" value="{{ $id }}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="container">
                                <label> Name :</label>
                                <div style="border: 1px solid #000000;padding-top: 4px;padding-left: 4px;padding-right: 4px;border-radius: 6px;">
                                    <input type="text" class="form-control inp" name="name" placeholder="name" style="border-bottom: 0px" value="{{ $name }}">
                                </div>
                                <span class="text_danger">
                                    @error('name')
                                    <label for="error" style="font-size: 12px; color: red;">{{ $message }}</label>
                                    @enderror
                                </span>
                            </div>
                            <div style="height: 20px;"></div>
                            ...
                            <div class="container">
                                <label> Email :</label>
                                <div style="border: 1px solid #000000;padding-top: 4px;padding-left: 4px;padding-right: 4px;border-radius: 6px;">
                                    <input type="text" class="form-control" name="email" placeholder="abc@gmail.com" style="border-bottom: 0px" style="outline: none" value="{{ $email }}">
                                </div>
                                <span class="text_danger">
                                    @error('email')
                                    <label for="error" style="font-size: 12px; color: red;">{{ $message }}</label>
                            ...
                            <div class="container">
                                ...
                                <select name="user_type" value="{{ old('user_type') }}"
                                    style="padding-left: 5px;padding-right: 5px; border: 1px solid #000000; border-radius: 6px;">
                                    <option value=""></option>
                                    @foreach ($user_type as $item)
                                    <option value="{{ $item->id }}">{{ $item-> users_type}}</option>
                                    @endforeach
                                </select>
                                <br>
                                <span class="text_danger">
                            ...
                            <div class="container">
                                ...
                                <div style="border: 1px solid #000000;padding-top: 4px;padding-left: 4px;padding-right: 4px;border-radius: 6px;">
                                    <input type="password" class="form-control" name="password" placeholder="password" style="border-bottom: 0px">
                                </div>
                                <span class="text_danger">
                                    @error('password')
                                    <label for="error" style="font-size: 12px; color: red;">{{ $message }}</label>
                            ...
                            <div class="container">
                                ...
                                <div style="border: 1px solid #000000;padding-top: 4px;padding-left: 4px;padding-right: 4px;border-radius: 6px;">
                                    <input type="password" class="form-control" name="rePassword" style="border-bottom: 0px" placeholder="Re-type password">
                                </div>
                                <span class="text_danger">
                                    @error('rePassword')
                    ...
                    <tr>
                        <td>
                            <div class="badge badge-40">
                                ...
                                <img src="asset/backend/assets/faces/w1.png" class="max-w-40 img-circle" alt="badge">
                            </div>
                        </td>
                        <td>Lucas smith</td>
                        <td>Australia</td>
                    ...
                    <tr>
                        <td>
                            <div class="badge badge-40">
                                ...
                                <img src="asset/backend/assets/faces/w2.png" class="max-w-40 img-circle" alt="badge">
                            </div>
                        </td>
                        <td>Janet Abshire</td>
                        <td>USA</td>
                    ...
                    <tr>
                        <td>
                            <div class="badge badge-40">
                                ...
                                <img src="asset/backend/assets/faces/w3.png" class="max-w-40 img-circle" alt="badge">
                            </div>
                        </td>
                        <td>Lucas Koch</td>
                        <td>England</td>
                    ...
                    <tr>
                        <td>
                            <div class="badge badge-40">
                                ...
                                <img src="asset/backend/assets/faces/w4.png" class="max-w-40 img-circle" alt="badge">
                            </div>
                        </td>
