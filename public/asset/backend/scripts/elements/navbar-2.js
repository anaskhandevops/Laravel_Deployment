...
(function() {
    $(function() {
        ...
        $(document).on('click', '.toggle-layout', function(e) {
            ...
            if (layout === 'fixed-navbar-1' && $('body').hasClass('layout-collapsed')) {
                $('.left-sidebar-backdrop').toggleClass('fade in');
            }
            return false;
        });
        ...
        $(document).on('click', '.toggle-right-sidebar', function(e) {
            ...
            if (layout === 'default-sidebar-2' && $('.right-sidebar-outer').hasClass('show-from-right')) {
                ...
                $('.right-sidebar-backdrop').toggleClass('fade in');
            } else if (layout === 'fixed-navbar-1' && $('.right-sidebar-outer').hasClass('show-from-right')) {
                $('.right-sidebar-backdrop').toggleClass('fade in');
            } else {
        ...
        $(document).on('click', '.toggle-search', function(e) {
            ...
            $('.top-search-backdrop').toggleClass('fade in');
            return false;
        });
        $('.top-search-backdrop').on('click', function() {
            $('.top-search').removeClass('show-from-top');
            $(this).removeClass('fade');
            $(this).removeClass('in');
        });
    });
